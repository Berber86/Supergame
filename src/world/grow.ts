 ...
 * вода, грива, роща). Пороги: 1, 2, 4, 7, 11, 16, 22… действий
 * после предыдущего расширения, с прибавками +1, +2, +3 и так далее.
 *
...
export interface GrowState {
  ...
  progress: number;
  /** Сколько расширений было: порог следующего = 1 + stage * (stage + 1) / 2. */
  stage: number;
...
/**
 * Действия после предыдущего расширения: 1, 2, 4, 7, 11, 16, 22, 29, 37…
 * Ступени нумеруются с нуля; каждый следующий прирост порога на единицу больше.
