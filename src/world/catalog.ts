...
export const ITEMS: CatalogItem[] = [
  ...
  // Обустройство: брёвна, пни, заборчики и прочие милости
  {
    id: 'moss_log',
    name: 'Замшелое бревно',
    hint: 'ящерицы греются на тёплой коре',
    kind: 'deco',
    w: 1,
    h: 2,
    step: 0.5,
  ...
  },
  {
    id: 'stump',
    name: 'Пень',
    hint: 'старый пень — пристанище ежей и мышей',
    kind: 'deco',
    w: 1,
    h: 1,
    step: 0.5,
  ...
  },
  {
    id: 'jizo',
    name: 'Дзидзо',
    hint: 'каменный страж в красном нагруднике',
    kind: 'deco',
    w: 1,
    h: 1,
    step: 0.5,
  ...
  {
    id: 'fence_wood',
    name: 'Деревянный заборчик',
    hint: 'низкая решётка из тёплого дерева',
    kind: 'deco',
    w: 1,
    h: 2,
    step: 1,
  ...
  },
  {
    ...
    hint: 'сухая кладка из плоских плит',
    kind: 'deco',
    w: 1,
    h: 2,
    step: 1,
  ...
  },
  {
    id: 'well',
    name: 'Старый колодец',
    hint: 'каменное кольцо с воротом и черпаком',
    kind: 'deco',
    w: 2,
    h: 2,
    step: 1,
  ...
  },
  {
    id: 'nestbox',
    name: 'Скворечник',
    hint: 'весной синицы таскают туда подстилку',
    kind: 'deco',
    w: 1,
    h: 1,
    step: 0.5,
  ...
  },
  {
    id: 'matatabi',
    name: 'Мататаби',
    hint: 'кошачья радость: коты приходят тереться',
    kind: 'shrub',
    w: 1,
    h: 1,
    step: 0.25,
