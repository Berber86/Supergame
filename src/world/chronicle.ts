...
export const CHRONICLE: Record<string, ChronicleText> = {
  ...
  star_fall: {
    kanji: '星',
    text: 'Ночью падала звезда. Кот поднял голову и долго смотрел туда, где света больше не стало.',
  },
  meet_duck: {
    kanji: '鸭',
    text: 'На пруду появились утки: пара плавает кругами, никуда не торопясь, как по собственному расписанию.',
  },
  cat_purr: {
    kanji: '撫',
    text: 'Кот подставил спинку и замурлыкал: в саду тепло и безопасно.',
  },
  rake_gravel: {
    kanji: '砂',
    text: 'Грабли коснулись гравия: сад камней покрылся чистыми узорами воды.',
  },
};
