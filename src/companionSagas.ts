...
const tiphysStanceLanguage: Record<CompanionStoryStance, Omit<ReactiveSagaContext, 'stance'>> = {
  trusted: { label: 'ГОРЬКОЕ ДОВЕРИЕ', arrival: 'Тифий не прячется за напускной холодностью. Он смотрит на почерневшее небо и прямо говорит Одиссею о том, как у него дрожат руки. Это признание — высшая форма верности от человека, привыкшего всегда быть скалой.', hook: 'Доверие делает эту тьму ещё более вязкой: теперь он боится не только за себя, но и за то, что подведёт человека, который в него верит.', choiceTitle: 'Встать с ним у штурвала', choiceDescription: 'Не укрываться за царским приказом. Разделить с ним груз невозможного выбора в этой темноте.', aftermath: 'Вы разделили эту слепоту на двоих, и доверие выдержало проверку бездной.', loyalty: 3, respect: 2, fear: -2 },
  controlled: { label: 'МЁРТВЫЙ КОМПАС', arrival: 'Тифий действует, как заведённый механизм. Взгляд остекленел, спина прямая. Вы превратили его в идеальный руль, но идеальный руль не умеет импровизировать, когда ломаются законы природы.', hook: 'Если приказать ему вести вслепую, он выполнит приказ, но его разум может окончательно треснуть от перенапряжения.', choiceTitle: 'Освободить живой разум', choiceDescription: 'Отказаться от привычки указывать. Задать вопрос и позволить механизму снова стать человеком.', aftermath: 'Ледяная скорлупа контроля дала трещину. Тифий осознал, что царю нужен его талант, а не только покорность.', loyalty: 1, respect: 3, fear: -1 },
  complicit: { label: 'КРОВАВЫЙ КИЛЬВАТЕР', arrival: 'Вы обмениваетесь мрачными взглядами. Между вами — тайна прошлых решений, скрытая от матросов. Эта тьма кажется ему знакомой, ведь в душах у вас не светлее.', hook: 'Общая тайна связывает, но в экстремальной ситуации она может превратиться в паранойю. Каждый ждёт предательства.', choiceTitle: 'Вывести правду из мрака', choiceDescription: 'Прекратить шептаться за спинами экипажа. Сделать выбор открыто, разделяя ответственность со всеми.', aftermath: 'Тьма вокруг вас осталась, но тьма между вами рассеялась. Вы перестали быть сообщниками и попытались стать соратниками.', loyalty: 2, respect: 1, fear: 1 },
  resentful: { label: 'СОЛЁНАЯ НЕНАВИСТЬ', arrival: 'Тифий цедит слова сквозь зубы. Он не забыл старых обид и уверен: если корабль пойдёт ко дну, Одиссей первым вцепится в единственное бревно.', hook: 'Он ждёт, что его сделают козлом отпущения. Любое красивое слово о единстве будет воспринято как издёвка.', choiceTitle: 'Признать его право на ненависть', choiceDescription: 'Не пытаться купить дешёвое примирение. Сказать прямо: вы здесь не ради дружбы, а ради выживания.', aftermath: 'Ненависть не исчезла, но сменилась холодным уважением. Прагматизм оказался честнее лживой заботы.', loyalty: 2, respect: 3, fear: -1 },
  forgiven: { label: 'ХРУПКИЙ ШТИЛЬ', arrival: 'Старые счёты оплачены, но раны ещё ноют. Тифий дал вам шанс, однако в этой черноте он внимательно следит: не вернётесь ли вы к старым, жестоким привычкам.', hook: 'Прощение — не гарантия. Одно движение, похожее на предательство, и этот хрупкий мир разлетится в щепки.', choiceTitle: 'Сдержать клятву доверия', choiceDescription: 'Показать делом, что прошлые уроки усвоены. Поставить жизнь экипажа выше своей власти.', aftermath: 'Перемирие выдержало испытание тьмой. Тифий понял, что его прощение не было выброшено на ветер.', loyalty: 4, respect: 2, fear: -2 },
}
