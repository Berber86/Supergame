...
const lizard = animal<Lizard>(
  {
    id: 'lizard',
    name: 'Ящерица',
    latin: 'Plestiodon japonicus',
    group: 'Пресмыкающиеся',
    scale: 8,
    baseline: 0.6,
    description:
      'Японский садовый сцинк: глянцевое тело с тёмной спинной полосой и светлым брюшком, пятипалые лапы с коготками и длинный гибкий хвост. При ходьбе позвоночник изгибается волной; греясь, ящерица припадает к камню, делает «отжимания» и раздувает горло. У молодой формы золотистые полосы и ярко-синий хвост.',
    habitat:
